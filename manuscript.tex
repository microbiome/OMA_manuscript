...
and computing speed (https://github.com/microbiome/benchmarking and
Figure~\ref{fig-benchmarking}). Conversion functions and detailed cheat
sheets between the two formats are available to bridge the gap between
...
for five common analytical operations applied to random subsets of
samples from the GrieneisenTSData experiment \citep{Grieneisen2021}.
Overall, the TreeSE approach outperforms phyloseq. While speedyseq is
...
The mia contributors: Thomaz Bastiaanssen, Moritz E. Beber, Aituar
Bektanov, Giulio Benedetti, Tuomas Borman, Domenick J. Braccia, Héctor
Corrada Bravo, Matteo Calgaro, Danielle Callan, Yang Cao, Jiya
Chaudhary, Sneha Das, Basil Courbayre Dussau, Henrik Eckermann, Pande
Erawijantari, Felix M. Ernst, Elliot Gaudron-Parry, Maija Hakula, Kati
Hanhineva, Aki Havulinna, Rasmus Hindström, Ruizhu Huang, Akewak Jeba,
Leo Lahti, Himmi Lindgren, Yihan Liu, Himel Mallick, Dattatray Mongad,
Christian L. Müller, Geraldson Muluh, Signe Nynäs, Jesse Pasanen, Joao
Paulo, Juho Pelto, Stefanie Peschel, Renuka Potbhare, Théotime Pralas,
Marcel Ramos, Aura Raulo, Artur Sannikov, Ely Seraidarian, Jacques
Serizay, Sudarshan Shetty, Rajesh Shigdel, Vilhelm Suksi, Eetu Tammi,
Benjamin Valderamma, Levi Waldron, Lu Yang.
