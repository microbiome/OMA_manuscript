...
Overall, the TreeSE methods outperformed phyloseq. While speedyseq was
faster in certain operations, TreeSE scaled more efficiently in both
execution time (s) and allocated memory (MB) with increasing sample size
(n).}
