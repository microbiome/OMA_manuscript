...
abstract: |
  ...
  has recently developed an optimised statistical programming framework for
...
necessitate specialised approaches in their analysis
...
Bioconductor addresses this through standardised data structures supported
...
research communities. They have been implemented through specialised
...
standardised solution to store tabular data by linking numeric abundance
...
(n) increases. Despite these advantages, optimising time and memory consumption 
...
specialised solutions for data analysis [@Jeganathan2021; @Willis2019;
...
mappings as described above. This integrated data object can then be analysed 
...
Microbiome data analysis often relies on specialised statistical approaches
...
[@goodrich2014]. Unsupervised techniques commonly used include Principal Component
...
specialised microbiome techniques including microbial community typing
...
access to the shared, standardised methods supporting the integrative data containers.
...
abundance tables within the same data objects but specialised methods
...
While spatio-temporal analyses require specialised methods, the miaTime R package
...
data, these analyses require specialised approaches, as proposed in previous
...
@Hocquet2024]. standardised data structures can enhance the transparency,
