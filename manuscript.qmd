...
framework. Conversion functions and detailed cheat sheets
between the two formats are available in the online book to support interoperability
...
(Tree)SE data container is broadly applicable to different modalities such as
...
(*e.g.* DESeq2), metabolomics [@nickols2024], or proteomics [@anwar2025] and the
