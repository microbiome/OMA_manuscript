...
[@wen2023; @shetty2019].
Accordingly, a need for standardization has been highlighted
[@moreno-indias2021].
...
time into core analytical tasks.
...
other profiles and alternative feature representations. It can also offer
...
integration and analysis based on the two integrative data containers, (Tree)SE
and MAE (Figure \ref{fig:workflow}).
...
structured data interoperability via standard containers such as TreeSE and MAE.
...
#|   Bolivia and Bangladesh compared to Finland.  **c-d**, Multidimensional
#|   Scaling (MDS) using UniFrac distances and Distance-based Redundancy
#|   Analysis (dbRDA) based on Aitchison distance, respectively. Both
...
#|   microbial profile and age. **e-f**, Faith's phylogenetic diversity by
