...
toolset (see the online book for a comprehensive overview of packages in the ecosystem).
...
maintainer who is notified of failures and resolves them in a timely manner. Finally,
community guidelines and continuous integration practices, together with shared
data structures, further improve interoperability between packages.
...
methods in microbiome research support the (Tree)SE framework, including methods
...
as CCA, joint-RPCA [@martino2025] and multiblock partial least squares
discriminant analysis (PLS-DA) [@singh2019] model shared latent structure across
modalities, enabling the discovery and visualization of coordinated variation
